...
{ path : 'test1', loadChildren: () => import('./test1/test1.module').then(m => m.Test1Module), canActivate: [AuthGuard] } , 
{ path : 'screen129985', loadChildren: () => import('./screen129985/screen129985.module').then(m => m.Screen129985Module), canActivate: [AuthGuard] } , 
];
